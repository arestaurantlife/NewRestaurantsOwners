    ...
    <section className="relative min-h-screen flex items-center pt-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          <div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold/20 border border-gold/30 mb-6 animate-fade-up"
            style={{ animationDelay: "0.1s" }}
          >
            <span className="w-2 h-2 rounded-full bg-gold animate-pulse" />
            <span className="text-gold text-sm font-medium">
              Trusted by 2,500+ Restaurant Owners
            </span>
          </div>
          ...
          <div
            className="flex items-center gap-8 mt-10 animate-fade-up"
          ...
          >
            <div className="flex -space-x-3">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full bg-cream border-2 border-charcoal flex items-center justify-center text-sm font-semibold text-charcoal"
                >
