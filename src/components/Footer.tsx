      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <a href="mailto:hello@newrestaurantowners.com" className="flex items-center gap-3 text-primary-foreground/70 hover:text-gold transition-colors">
        ...
        <div className="border-t border-primary-foreground/10 mt-12 pt-8">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#" className="text-primary-foreground/60 hover:text-gold transition-colors" aria-label="YouTube">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
